    ...
    <>
      ...
      {!isOpen && (
        <Button
          ...
          className="fixed bottom-20 left-4 z-50 rounded-full w-16 h-16 shadow-lg bg-primary hover:bg-primary/90 relative overflow-hidden"
        >
      ...
      {isOpen && (
        <Card className={cn(
          "fixed bottom-20 left-4 z-50 transition-all duration-300 ease-in-out",
