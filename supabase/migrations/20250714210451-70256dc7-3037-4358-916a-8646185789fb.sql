...
CREATE INDEX IF NOT EXISTS idx_task_time_entries_user_date ON public.task_time_entries(user_id, date_trunc('day', start_time));
CREATE INDEX IF NOT EXISTS idx_file_analytics_project_date ON public.file_analytics(project_id, date_trunc('day', created_at));
